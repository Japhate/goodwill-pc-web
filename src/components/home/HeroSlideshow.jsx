                  ...
                  <div className="welcome-hero-copy ml-[3vw] max-w-[min(68vw,620px)] sm:ml-[6vw] sm:max-w-[min(64vw,660px)] md:ml-[10vw] md:max-w-[min(78vw,720px)] lg:ml-[12vw]">
                    ...
                    {welcomeHeroUrl && (
                      <div className="mt-3 flex flex-wrap items-stretch gap-2 sm:mt-4 sm:gap-3 md:mt-7 md:gap-4">
                        ...
                        <a
                          href={welcomeHeroUrl}
                          className="welcome-hero-cta pointer-events-auto group relative inline-flex items-center gap-2 overflow-hidden rounded-xl border border-amber-100/80 bg-gradient-to-r from-[#c58a1f] via-[#f3c45b] to-[#b87918] px-3 py-1.5 text-xs font-bold text-[#2d1c12] shadow-[0_14px_36px_rgba(0,0,0,0.35),0_0_28px_rgba(243,196,91,0.28)] ring-1 ring-white/30 transition-all duration-500 hover:-translate-y-0.5 hover:scale-[1.03] hover:rounded-2xl hover:from-[#f4cc69] hover:via-[#fff0a8] hover:to-[#c58a1f] hover:shadow-[0_18px_42px_rgba(0,0,0,0.42),0_0_38px_rgba(243,196,91,0.45)] focus:outline-none focus:ring-4 focus:ring-amber-200/55 sm:px-3.5 sm:py-2 sm:text-sm md:px-4 md:py-2.5 md:text-base"
